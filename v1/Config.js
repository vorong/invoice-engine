...
const SPREADSHEET_ID_INVOICE_DATA_EXTRACTION = scriptProperties.getProperty('SPREADSHEET_ID_INVOICE_DATA_EXTRACTION');
const SHEET_NAME_FILE_REGISTRY = 'FILE_REGISTRY';
const SHEET_NAME_INVOICE_EXTRACTION_STRUCTURED = 'INVOICE_EXTRACTION_STRUCTURED';
...
const FOLDER_ID_INVOICE_SOURCE = scriptProperties.getProperty('FOLDER_ID_INVOICE_SOURCE');
const FOLDER_ID_INVOICE_CONVERTED_GDOC = scriptProperties.getProperty('FOLDER_ID_INVOICE_CONVERTED_GDOC');
const FOLDER_ID_INVOICE_CONVERTED_HTML = scriptProperties.getProperty('FOLDER_ID_INVOICE_CONVERTED_HTML');
const FOLDER_ID_INVOICE_CONVERTED_PDF = scriptProperties.getProperty('FOLDER_ID_INVOICE_CONVERTED_PDF');
...
////////////////////////////////////////////////////////////////////////////////
const SPREADSHEET_ID_INVOICE_DATA_EXPORT = scriptProperties.getProperty('SPREADSHEET_ID_INVOICE_DATA_EXPORT');

////////////////////////////////////////////////////////////////////////////////
// Invoice Supporting Extraction Constants.                                   //
////////////////////////////////////////////////////////////////////////////////
const SPREADSHEET_ID_SUPPORTING_DATA_EXTRACTION = scriptProperties.getProperty('SPREADSHEET_ID_SUPPORTING_DATA_EXTRACTION');
const SHEET_NAME_COMPANY_WEBSITE_EXTRACTION_RAW = 'COMPANY_WEBSITE_EXTRACTION_RAW';
